 ...
 *
 */
public class MetaConstraintLastLevelBuilder implements ConstraintBuilder {
	...
	public Constraint[] build(Agent[] agents, Provider<IEquilibriumConcept> equilibriumConcept,
		...
		for (int i = 1; i < agents.length; i++) {
			...
			allConstraint[i-1]= new Constraint("metaConstraint_agent_"+agents[i].getID(), new MetaBFSConstraintLastLevelOnly(equilibriumConcept, agent, PropagatorPriority.VERY_SLOW, recorder, policy, varHelper));
		}
