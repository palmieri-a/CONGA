 ...
 * the following normal form game: P1 1 2 ------------------- | | | 1 | (1,1) |
 * (0,0) | | | | P2 ------------------- | | | 2 | (0,0) | (1,1) | | | |
 * -------------------
 * 
 * @author Anthony
 *
 */
public class TwoPSymmetricGame extends AbstractGameModel {

	public TwoPSymmetricGame() {
		super(2);
	}
	...
	public void buildModel(Model s) {
		...
		allowed.add(new int[] { 1, 1, 1, 1 }, new int[] { 1, 2, 0, 0 }, new int[] { 2, 1, 0, 0 },
				new int[] { 2, 2, 1, 1 });
