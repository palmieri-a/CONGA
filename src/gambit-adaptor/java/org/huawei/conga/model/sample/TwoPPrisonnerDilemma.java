...
/**
 * This is an example of the prisonner dilemma problem with 2 players. It is
 * represented under a COG problem, it can also be represented we a CSG. This
 * game correspond to the following normal form game: P1 1 2 -------------------
 * | | | 1 | (1,1) | (0,1) | | | | P2 ------------------- | | | 2 | (1,0) |
 * (0,0) | | | | -------------------
 * 
 * @author Anthony
 *
 */
public class TwoPPrisonnerDilemma extends AbstractGameModel {

	public TwoPPrisonnerDilemma() {
		super(2);
	}
	...
	public void buildModel(Model s) {
		...
		allowed.add(new int[] { 1, 1, 1, 1 }, new int[] { 1, 2, 1, 0 }, new int[] { 2, 1, 0, 1 },
				new int[] { 2, 2, 0, 0 });
